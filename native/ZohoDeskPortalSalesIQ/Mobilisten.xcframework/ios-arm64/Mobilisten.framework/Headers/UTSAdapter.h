...
- (void)initWithApiKey:(NSString *)apiKey andAccessKey:(NSString *)accessKey bundleId:(NSString *)bundle useragent:(NSString *)ua domain:(NSString *)dom language:(NSString *)lan andtheHeader:(NSMutableDictionary *)theHeader;
@end

...
- (void)webSocket:(LDSRWebSocket *)webSocket onReceivingMessage:(id)message;
- (void)onConnectionOpen:(LDSRWebSocket *)webSocket;
- (void)onClose:(LDSRWebSocket *)webSocket reason:(NSString *)reason complete:(BOOL)completed;

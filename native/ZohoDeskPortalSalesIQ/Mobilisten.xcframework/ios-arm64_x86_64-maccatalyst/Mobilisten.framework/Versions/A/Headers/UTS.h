...
- (void)initWithApiKey:(NSString *)apiKey andAccessKey:(NSString *)accessKey bundleId:(NSString *)bundle domain:(NSString *)dom language:(NSString *)lan andtheHeader:(NSDictionary *)theHeader;

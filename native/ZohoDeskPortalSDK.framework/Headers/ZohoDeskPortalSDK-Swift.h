...
#ifndef ZOHODESKPORTALSDK_SWIFT_H
#define ZOHODESKPORTALSDK_SWIFT_H
...
+ (void)setNavigationBarColor:(UIColor * _Nonnull)value;
...
+ (void)setTitleColor:(UIColor * _Nonnull)value;
...
+ (void)setBarButtonTextColor:(UIColor * _Nonnull)value;
...
+ (void)setStatusBarApperance:(UIStatusBarStyle)value;
...
+ (void)setBackButtonStyle:(enum ZDNavigationBackButtonStyle)value;
@end
...
+ (void)setEnableLogMessages:(BOOL)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) UIModalPresentationStyle presentationStyle;)
+ (UIModalPresentationStyle)presentationStyle SWIFT_WARN_UNUSED_RESULT;
+ (void)setPresentationStyle:(UIModalPresentationStyle)value;
...
+ (void)setSetSDKLanguage:(NSString * _Nonnull)value;
@end

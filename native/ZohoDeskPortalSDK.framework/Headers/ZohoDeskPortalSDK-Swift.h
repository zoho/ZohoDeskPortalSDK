...
@interface CALayer (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end
...
@interface NSDateFormatter (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end
...
@interface NSFileManager (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end
...
@interface NSAttributedString (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end
...
@interface NSDictionary (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end


@interface NSFetchedResultsController (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end


@interface NSManagedObjectContext (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end
...
@interface NSMutableAttributedString (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end


@interface NSMutableData (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end


@interface NSMutableString (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end


@interface NSObject (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end
...
SWIFT_CLASS("_TtC17ZohoDeskPortalSDK9Provoider")
...
@interface TicketDetailViewController (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end
...
@interface UIButton (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end


@interface UICollectionView (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end
...
@interface UIColor (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end
...
@interface UIFont (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end
...
@interface UIImage (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end
...
@interface UILabel (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end


@interface UINavigationBar (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end


@interface UIView (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end
...
@interface UIViewController (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end
...
@interface UIViewController (SWIFT_EXTENSION(ZohoDeskPortalSDK)) <UIGestureRecognizerDelegate>
@end
...
@interface UIViewController (SWIFT_EXTENSION(ZohoDeskPortalSDK)) <UIViewControllerTransitioningDelegate>
...
@interface NSUserDefaults (SWIFT_EXTENSION(ZohoDeskPortalSDK))
@end
...
SWIFT_PROTOCOL("_TtP17ZohoDeskPortalSDK20ZohoDeskchatDelegate_")
@protocol ZohoDeskchatDelegate

...
///
- (void)setThemeColor:(UIColor * _Nonnull)color SWIFT_DEPRECATED_MSG("Customize the themeColor using `customTheme.themeColor` property in object from ZohoSalesIQ.Theme.baseTheme and set the custom theme using the ZohoSalesIQ.Theme.setTheme method");
...
@property (nonatomic, strong) UIColor * _Null_unspecified queuePositionTextColor;

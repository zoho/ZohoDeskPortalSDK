...
@class SIQFLAnimatedImage;
@protocol SIQFLAnimatedImageViewDebugDelegate;


//
//  An `SIQFLAnimatedImageView` can take an `FLAnimatedImage` and plays it automatically when in view hierarchy and stops when removed.
...
//
@interface SIQFLAnimatedImageView : UIImageView
...
@property (nonatomic, strong) SIQFLAnimatedImage *animatedImage;
